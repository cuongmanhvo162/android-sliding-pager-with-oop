...
import cuongvo.ndroid_walkthrough_with_oop.adapter.SlidePagerAdapter;
import cuongvo.ndroid_walkthrough_with_oop.data.SlideData;
import cuongvo.ndroid_walkthrough_with_oop.util.WalkthroughUtil;
import cuongvo.ndroid_walkthrough_with_oop.view.IndicatorView;
...
public class WalkthroughActivity extends Activity {
    ...
    private void createWalkthroughList() {
        final List<SlideData> list = WalkthroughUtil.getWalkthroughList(this);
